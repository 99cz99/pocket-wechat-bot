...
Write-Host "  微信给 bot 发 /whoami -> 记下返回的 OpenID"
Write-Host "  手机 Termux 里: nano ~/cc-connect/CLAUDE.md"
Write-Host "  找到 <YOUR_WECHAT_OPENID> 替换为你的 OpenID"
Write-Host "  （不替换不影响聊天，但 admin 指令不生效）"
Write-Host ""
